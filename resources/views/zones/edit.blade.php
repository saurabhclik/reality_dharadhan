...
@section('title', 'Edit Zone | Pro-leadexpertz')
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Edit Zone: {{ $zone->zone_name }}</h5>
                        </div>
                        <div class="card-body">
                            @if(session('error'))
                            ...
                            <form class="needs-validation" novalidate action="{{ route('zone.update', $zone->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="zone_name" name="zone_name" 
                                                   value="{{ old('zone_name', $zone->zone_name) }}" required maxlength="255">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="sub_area" name="sub_area" 
                                                   value="{{ old('sub_area', $zone->sub_area) }}" maxlength="255">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="pincode" name="pincode" 
                                                   value="{{ old('pincode', $zone->pincode) }}" maxlength="10" pattern="[0-9]{6,10}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="zone_order" name="zone_order" 
                                                   value="{{ old('zone_order', $zone->zone_order) }}" min="0">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch mt-2">
                                                <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ old('status', $zone->status) ? 'checked' : '' }}>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <div class="alert alert-light border">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <small class="text-muted d-block">Created: {{ $zone->created_at ? date('d M Y, h:i A', strtotime($zone->created_at)) : 'N/A' }}</small>
                                                </div>
                                                <div class="col-md-6">
                                                    <small class="text-muted d-block">Last Updated: {{ $zone->updated_at ? date('d M Y, h:i A', strtotime($zone->updated_at)) : 'N/A' }}</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mt-4">
                                    <button type="submit" id="SubmitZoneBtn" class="btn btn-primary px-4 py-2">
                                        <span id="ZoneSubmitText">
                                            <i class="bi bi-save me-2"></i> Update Zone
                                        </span>
