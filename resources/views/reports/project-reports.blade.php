...
@section('title', 'Project Reports | Pro‑leadexpertz')
                ...
                <div class="table-responsive">
                    <table class="table table-bordered dt-responsive nowrap w-100" id="table">
                        ...
                        @php
                            ...
                            'new_leads','pending','processing','interested',
                            'whatsapp','meeting_scheduled','call_scheduled','visit_scheduled','visit_done',
                            'booked','completed','cancelled','not_reachable',
                            'wrong_number','channel_partner','not_interested','not_picked','lost'
                            ], 0);
                        @endphp
