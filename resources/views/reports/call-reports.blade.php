...
@section('title', 'Calling Report | Pro-leadexpertz')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Calling Report</h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Reports</a></li>
                            <li class="breadcrumb-item active">Calling Report</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body bg-light">
                        <form method="GET" action="{{ route('report.call_reports') }}" class="form-inline" id="filterForm">
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <a href="{{ route('report.call_reports') }}" class="btn btn-outline-secondary">Clear</a>
                                </div>
                            </div>
                        </form>
                    </div>
